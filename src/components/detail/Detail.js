  ...
  return (
    <div className="detail flex-[1]">
      ...
      <div className="info p-5 flex flex-col gap-6">
          ...
          <div className="photos flex flex-col gap-5 mt-5">
            <div className="photoItem flex items-center justify-between">
              <div className="photoDetail flex items-center justify-center gap-5">
                <Image
                  className="h-10 rounded-sm object-cover self-start"
                  src="/bg.webp"
                  alt=""
                  width={40}
                  height={40}
        ...
        <button className="p-4 bg-[rgba(230,74,105,0.553)] text-white border-none rounded-md cursor-pointer outline-none hover:bg-[rgba(230,74,105,0.796)]">Block User</button>
        <button className="logout p-2.5 bg-[#1a73e8]">Logout</button>
      </div>
    </div>
  );
};
